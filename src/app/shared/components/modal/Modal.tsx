      ...
      <div className="absolute w-3/4 h-3/4 z-10  bg-rose-700 overflow-auto text-white p-6 rounded-lg">
        ...
        <div className="flex-col sm:flex md:flex-row md:items-center">
          ...
          <div className="w-4/4 flex justify-center items-center">
            <div className=" h-100 relative flex items-center justify-center flex-col mb-2 ">
              <div
                className="h-80 w-full bg-cover bg-center sm:h-100"
                style={{ backgroundImage: `url('${character.background}')` }}
              >
                <img className=" h-80 sm:h-100" src={character.fullPortrait} alt="" />
              </div>
            </div>

          </div>

          <div className=" w-4/4 p-4 ml-1 md:w-2/4">
        ...
        <div className="w-full flex-col gap-4">
          <p className="flex gap-4 items-center m-2">
          ...
          <p className="gap-4 items-center">
            <p className="font-bold m-2"> Habilidades: </p>
            {character.abilities.map((abilities, index) => (
              <div className="m-2">
                <p key={index} className="font-bold ml-2 flex gap-2 items-center ">
                {abilities.displayName}:
                <img className="size-7" src={abilities.displayIcon} alt="" />
                </p>
                <p className="w-4/4 m-1">{abilities.description}</p>
              </div>
